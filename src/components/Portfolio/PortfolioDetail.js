          ...
          <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
            <Card className={styles.Card}>
              ...
              <div className={styles.ParagrahContainer}>
                <p>
                  Velit exercitation enim cupidatat sint. Ut consequat amet anim
                  consequat minim ad ex culpa nulla magna ullamco eu. Occaecat
                  magna deserunt dolore occaecat irure eu anim fugiat deserunt
                  cillum mollit sint veniam labore. Velit exercitation enim
                  cupidatat sint. Ut consequat amet anim consequat minim ad ex
                  culpa nulla magna ullamco eu. Occaecat magna deserunt dolore
                  occaecat irure eu anim fugiat deserunt cillum mollit sint
                  veniam labore.
                </p>
              </div>
            </Card>
